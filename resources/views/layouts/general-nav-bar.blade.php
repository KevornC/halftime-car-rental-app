...
<body>
  ...
  <nav class="bg-gray-100 font-sans flex flex-col text-center content-center sm:flex-row sm:text-left sm:justify-between py-2 px-6 shadow sm:items-baseline w-full">

    <div class="mb-2 sm:mb-0 flex flex-row ">
    </div>
    <div class="">
          <!-- SEARCH component -->
              <div class="flex justify-items-center items-center mx-auto bg-white rounded-lg " x-data="{ search: '' }">
                  <div class="w-full">
                      <input type="search" class="w-full px-4 py-1 text-gray-800 rounded-full focus:outline-none"
                          placeholder="search vehicle..." x-model="search">
                  </div>
                  <div class="ml-48">
                      <button type="submit" class="flex items-center navcolor justify-center w-12 h-12 text-white rounded-r-lg"
    ...
    <div class="sm:mb-0 self-center">
      <!-- <div class="h-10" style="display: table-cell, vertical-align: middle;"> -->
      <a href="{{route('aboutus')}}" class="text-md no-underline text-blue-dark hover:text-blue-dark ml-2 px-1">About us</a>
      <a href="{{route('contact')}}" class="text-md no-underline text-blue-dark hover:text-blue-dark ml-2 px-1">Contact us</a>
      <!-- </div> -->
...
<footer class="cardfounder MT-5" aria-labelledby="footer-heading">
  ...
  <div class="max-w-7xl mx-auto pt-12 pb-5 px-4 sm:px-6 lg:pt-16 lg:px-8">
      ...
      <div class="mt-8 xl:mt-0">
        ...
        <form class="mt-4 sm:flex sm:max-w-md">
          ...
          <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            <button type="submit" class="w-full navcolor flex items-center justify-center border border-transparent rounded-md py-2 px-4 text-base font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Subscribe
            </button>
          </div>
        </form>
...
<section>
  <div class="border-t navcolor border-gray-200 py-8 px-5 md:flex md:items-center md:justify-between">
