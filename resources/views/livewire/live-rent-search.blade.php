...
<div>
    <div class="  bg-gray-100 py-1 flex flex-col justify-center sm:py-12">
        <div class="relative px-1 py-10 bg-white sm:rounded-1xl sm:p-20">
            <h1 class="text-black text-center text-lg pb-10">Filter your search</h1>
            <div class="grid sm:grid-cols-2 gap-4">
            <div>
           
                <label for="" class="text-xs font-semibold px-1 text-black">Search vehicle brand</label>
                <div class="flex">
                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                    <select id="country" name="country" autocomplete="country" class="w-1/2 -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">
                ...
                <label for="" class="text-xs font-semibold px-1 text-black">Search vehicle capacity</label>
                <div class="flex">
                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                    <select id="country" name="country" autocomplete="country" class="w-1/2 -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">
                        <option>choose one</option>
            ...
            <div>
                    ...
                    <label for="" class="text-xs font-semibold px-1 text-black">Select driver type</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                        <select id="country" name="country" autocomplete="country" class="w-1/2 -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">
                            <option>Choose one</option>
                    ...
                    <label for="" class="text-xs font-semibold px-1 text-black">Select colour</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                        <select id="country" name="country" autocomplete="country" class="w-1/2 -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">
                            <option>Choose one</option>
